...
RSpec.describe FormsController, type: :controller do
  let(:user) { User.create(email: 'test@thegrowhaus.org') }
  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved form as @form" do
        post :create, {:form => invalid_attributes}, valid_session
        expect(assigns(:form)).to be_a_new(Form)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested form" do
        form = Form.create! valid_attributes
        put :update, {:id => form.to_param, :form => new_attributes}, valid_session
        form.reload
    ...
    context "with invalid params" do
      it "assigns the form as @form" do
        form = Form.create! valid_attributes
        put :update, {:id => form.to_param, :form => invalid_attributes}, valid_session
        expect(assigns(:form)).to eq(form)
      end
